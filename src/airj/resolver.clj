...
(def ^:private expr-resolvers
  {:local resolve-local-expr
   ...
   :float-add (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :float-sub (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :float-mul (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :float-div (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :float-eq (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :float-lt (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :float-le (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :float-gt (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :float-ge (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-add (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-sub (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-mul (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-div (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-eq (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-lt (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-le (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-gt (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :double-ge (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   ...
   :int->float (fn [expr env walk] (walk (:arg expr) env))
   :int->double (fn [expr env walk] (walk (:arg expr) env))
   :float->double (fn [expr env walk] (walk (:arg expr) env))
   :double->float (fn [expr env walk] (walk (:arg expr) env))
   :json-parse (fn [expr env walk] (walk (:arg expr) env))
   :json-write (fn [expr env walk] (walk (:arg expr) env))
   :env-get (fn [expr env walk] (walk (:arg expr) env))
   :process-run (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :http-listen (fn [expr env walk] (walk (:arg expr) env))
   :http-port (fn [expr env walk] (walk (:arg expr) env))
   :http-accept (fn [expr env walk] (walk (:arg expr) env))
   :http-respond (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :http-close (fn [expr env walk] (walk (:arg expr) env))
   ...
   :seq-empty (fn [_expr _env _walk] nil)
   ...
   :seq-rest (fn [expr env walk] (walk (:arg expr) env))
   :seq-append (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :seq-concat (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :seq-get (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :map-empty (fn [_expr _env _walk] nil)
   :map-set (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :map-get (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :map-contains? (fn [expr env walk] (resolve-expr-seq (:args expr) env walk))
   :map-keys (fn [expr env walk] (walk (:arg expr) env))
...
;; {:version 1, :tested-at "2026-03-16T07:27:12.019606-05:00", :module-hash "945596468", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 4, :hash "956527207"} {:id "form/1/declare", :kind "declare", :line 6, :end-line 6, :hash "1701706515"} {:id "defn-/fail!", :kind "defn-", :line 8, :end-line 10, :hash "1487409999"} {:id "defn-/declared-symbols", :kind "defn-", :line 12, :end-line 14, :hash "1928601396"} {:id "defn-/declared-function-symbols", :kind "defn-", :line 16, :end-line 18, :hash "2147335392"} {:id "defn-/imported-function-symbols", :kind "defn-", :line 20, :end-line 26, :hash "-337988883"} {:id "defn-/imported-airj-symbols", :kind "defn-", :line 28, :end-line 35, :hash "572454477"} {:id "defn-/check-imports", :kind "defn-", :line 37, :end-line 54, :hash "281404990"} {:id "defn-/check-exports", :kind "defn-", :line 56, :end-line 63, :hash "-822881886"} {:id "defn-/union-pattern-binders", :kind "defn-", :line 65, :end-line 67, :hash "411632936"} {:id "defn-/record-pattern-binders", :kind "defn-", :line 69, :end-line 71, :hash "-1442506129"} {:id "def/pattern-binder-handlers", :kind "def", :line 73, :end-line 78, :hash "1765640651"} {:id "defn/pattern-binders", :kind "defn", :line 80, :end-line 84, :hash "1177151671"} {:id "defn-/resolve-case", :kind "defn-", :line 86, :end-line 89, :hash "1606382642"} {:id "defn-/resolve-expr-seq", :kind "defn-", :line 91, :end-line 100, :hash "1630856682"} {:id "defn-/resolve-local-expr", :kind "defn-", :line 102, :end-line 106, :hash "112051099"} {:id "defn-/resolve-call-expr", :kind "defn-", :line 108, :end-line 111, :hash "1407574929"} {:id "defn-/resolve-construct-expr", :kind "defn-", :line 113, :end-line 115, :hash "-697969647"} {:id "defn-/resolve-record-get-expr", :kind "defn-", :line 117, :end-line 119, :hash "565073959"} {:id "defn-/resolve-if-expr", :kind "defn-", :line 121, :end-line 125, :hash "1449895441"} {:id "defn-/resolve-match-expr", :kind "defn-", :line 127, :end-line 131, :hash "-1909690062"} {:id "defn-/resolve-scoped-bindings", :kind "defn-", :line 133, :end-line 140, :hash "824488877"} {:id "defn-/resolve-let-expr", :kind "defn-", :line 142, :end-line 145, :hash "-649793452"} {:id "defn-/resolve-lambda-expr", :kind "defn-", :line 147, :end-line 150, :hash "1331153257"} {:id "defn-/resolve-try-expr", :kind "defn-", :line 152, :end-line 158, :hash "1855874410"} {:id "defn-/resolve-var-expr", :kind "defn-", :line 160, :end-line 162, :hash "-1302370245"} {:id "defn-/resolve-set-expr", :kind "defn-", :line 164, :end-line 166, :hash "80905257"} {:id "def/expr-resolvers", :kind "def", :line 168, :end-line 268, :hash "-1215517842"} {:id "defn/resolve-expr", :kind "defn", :line 270, :end-line 272, :hash "-214132923"} {:id "defn-/resolve-fn-decl", :kind "defn-", :line 274, :end-line 278, :hash "-1978958904"} {:id "defn/resolve-module", :kind "defn", :line 280, :end-line 289, :hash "-1647712934"}]}

...
(def ^:private free-locals-handlers
  {:local local-free-locals
   ...
   :http-listen (fn [expr bound] (free-locals (:arg expr) bound))
   :http-port (fn [expr bound] (free-locals (:arg expr) bound))
   :http-accept (fn [expr bound] (free-locals (:arg expr) bound))
   :http-respond (fn [expr bound]
                   (apply set/union #{} (map #(free-locals % bound) (:args expr))))
   :http-close (fn [expr bound] (free-locals (:arg expr) bound))

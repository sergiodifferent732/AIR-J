...
(defn- expr-checkers
  ...
  {:call (fn [expr ctx walk]
   ...
   :seq-first (fn [expr ctx walk]
                (walk (:arg expr) ctx))
   :seq-rest (fn [expr ctx walk]
               (walk (:arg expr) ctx))
   :seq-append (fn [expr ctx walk]
                 (doseq [arg (:args expr)]
                   (walk arg ctx)))
   :seq-concat (fn [expr ctx walk]
                 (doseq [arg (:args expr)]
                   (walk arg ctx)))
   :seq-get (fn [expr ctx walk]
              (doseq [arg (:args expr)]
                (walk arg ctx)))
   :map-empty (fn [_expr _ctx _walk] nil)
   :map-set (fn [expr ctx walk]
              (doseq [arg (:args expr)]
                (walk arg ctx)))
   :map-get (fn [expr ctx walk]
              (doseq [arg (:args expr)]
                (walk arg ctx)))
   :map-contains? (fn [expr ctx walk]
                    (doseq [arg (:args expr)]
                      (walk arg ctx)))
   :map-keys (fn [expr ctx walk]
               (walk (:arg expr) ctx))
...
;; {:version 1, :tested-at "2026-03-16T13:34:16.688338-05:00", :module-hash "-1897498841", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 5, :hash "160254700"} {:id "form/1/declare", :kind "declare", :line 7, :end-line 7, :hash "569079974"} {:id "defn-/fail!", :kind "defn-", :line 8, :end-line 10, :hash "-696871237"} {:id "defn-/decl-map", :kind "defn-", :line 12, :end-line 25, :hash "-76245029"} {:id "defn-/fn-type", :kind "defn-", :line 27, :end-line 32, :hash "1095575499"} {:id "defn-/module-fn-env", :kind "defn-", :line 34, :end-line 42, :hash "-90063424"} {:id "defn-/make-ctx", :kind "defn-", :line 44, :end-line 47, :hash "-261742596"} {:id "defn-/enum-pattern?", :kind "defn-", :line 49, :end-line 51, :hash "-31853100"} {:id "defn-/exhaustive-pattern?", :kind "defn-", :line 53, :end-line 57, :hash "1946202862"} {:id "defn-/bool-pattern-cover", :kind "defn-", :line 59, :end-line 62, :hash "-1417694324"} {:id "defn-/enum-pattern-cover", :kind "defn-", :line 64, :end-line 67, :hash "643520114"} {:id "defn-/union-pattern-cover", :kind "defn-", :line 69, :end-line 72, :hash "-150644182"} {:id "defn-/pattern-cover", :kind "defn-", :line 74, :end-line 82, :hash "558010568"} {:id "defn-/bool-exhaustive?", :kind "defn-", :line 84, :end-line 87, :hash "1512031583"} {:id "defn-/enum-exhaustive?", :kind "defn-", :line 89, :end-line 91, :hash "482651886"} {:id "defn-/union-exhaustive?", :kind "defn-", :line 93, :end-line 95, :hash "-972502524"} {:id "defn-/supported-exhaustive-type?", :kind "defn-", :line 97, :end-line 101, :hash "1140424323"} {:id "defn-/exhaustive-covers?", :kind "defn-", :line 103, :end-line 108, :hash "-416121724"} {:id "defn-/check-match", :kind "defn-", :line 110, :end-line 123, :hash "692717775"} {:id "defn-/bind-literal-pattern", :kind "defn-", :line 125, :end-line 127, :hash "-896453871"} {:id "defn-/bind-binder-pattern", :kind "defn-", :line 129, :end-line 133, :hash "868154269"} {:id "defn/bind-pattern", :kind "defn", :line 135, :end-line 143, :hash "-488411314"} {:id "defn-/extend-let-ctx", :kind "defn-", :line 145, :end-line 152, :hash "-1584068064"} {:id "defn-/expr-checkers", :kind "defn-", :line 154, :end-line 416, :hash "421202395"} {:id "defn/check-expr", :kind "defn", :line 418, :end-line 420, :hash "1259683610"} {:id "defn-/check-fn-decl", :kind "defn-", :line 422, :end-line 428, :hash "-640781828"} {:id "defn/check-module", :kind "defn", :line 430, :end-line 436, :hash "1272077568"}]}

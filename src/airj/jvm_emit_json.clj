...
(defn emit-json-parse
  ...
  (emit-require mv "airj.json-runtime")
...
;; {:version 1, :tested-at "2026-03-14T20:25:04.254149-05:00", :module-hash "104280456", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 2, :hash "-1494685321"} {:id "defn-/emit-clojure-var", :kind "defn-", :line 4, :end-line 13, :hash "487263659"} {:id "defn-/emit-require", :kind "defn-", :line 15, :end-line 31, :hash "-667175773"} {:id "defn/emit-json-parse", :kind "defn", :line 33, :end-line 45, :hash "97749785"} {:id "defn/emit-json-write", :kind "defn", :line 47, :end-line 58, :hash "-1724999590"}]}

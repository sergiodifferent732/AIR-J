...
(defn- try-effects
  ...
  (let [body-effects (walk (:body expr) ctx)
        catch-effects (apply set/union
                             #{}
                             (map (fn [catch]
                                    (walk (:body catch)
                                          (bind-local ctx (:name catch) (:type catch))))
                                  (:catches expr)))
        handled-body-effects (if (seq (:catches expr))
                               (disj body-effects 'Foreign.Throw)
                               body-effects)]
    (set/union handled-body-effects
               catch-effects
...
(defn- expr-effect-handlers
  ...
  {:call (fn [expr ctx walk]
   ...
   :process-run (fn [expr ctx walk]
                  (set/union #{'Process.Run 'Foreign.Throw}
                             (effect-union (:args expr) ctx walk)))
   :http-listen (fn [expr ctx walk]
                  (set/union #{'Http.Listen 'Foreign.Throw}
                             (walk (:arg expr) ctx)))
   :http-port (fn [expr ctx walk] (walk (:arg expr) ctx))
   :http-accept (fn [expr ctx walk]
                  (set/union #{'Http.Accept 'Foreign.Throw}
                             (walk (:arg expr) ctx)))
   :http-respond (fn [expr ctx walk]
                   (set/union #{'Http.Respond 'Foreign.Throw}
                              (effect-union (:args expr) ctx walk)))
   :http-close (fn [expr ctx walk]
                 (set/union #{'Http.Stop 'Foreign.Throw}
                            (walk (:arg expr) ctx)))
   ...
   :seq-rest (fn [expr ctx walk] (walk (:arg expr) ctx))
   :seq-append (fn [expr ctx walk] (effect-union (:args expr) ctx walk))
   :seq-concat (fn [expr ctx walk] (effect-union (:args expr) ctx walk))
   :seq-get (fn [expr ctx walk] (effect-union (:args expr) ctx walk))
   :map-empty (fn [_expr _ctx _walk] #{})
   :map-set (fn [expr ctx walk] (effect-union (:args expr) ctx walk))
   :map-get (fn [expr ctx walk] (effect-union (:args expr) ctx walk))
   :map-contains? (fn [expr ctx walk] (effect-union (:args expr) ctx walk))
   :map-keys (fn [expr ctx walk] (walk (:arg expr) ctx))
...
;; {:version 1, :tested-at "2026-03-16T13:32:21.394874-05:00", :module-hash "298895313", :forms [{:id "form/0/ns", :kind "ns", :line 1, :end-line 9, :hash "-1748354227"} {:id "defn-/fail!", :kind "defn-", :line 11, :end-line 13, :hash "1619150228"} {:id "defn-/decl-map", :kind "defn-", :line 15, :end-line 30, :hash "-2115152470"} {:id "defn-/fn-type", :kind "defn-", :line 32, :end-line 37, :hash "1095575499"} {:id "defn-/module-fn-env", :kind "defn-", :line 39, :end-line 56, :hash "-259056179"} {:id "defn-/ensure-subset", :kind "defn-", :line 58, :end-line 65, :hash "736755596"} {:id "defn-/make-ctx", :kind "defn-", :line 67, :end-line 80, :hash "-1038463474"} {:id "defn-/bind-call-effects", :kind "defn-", :line 82, :end-line 84, :hash "-198491742"} {:id "defn-/bind-local", :kind "defn-", :line 86, :end-line 88, :hash "1658319653"} {:id "defn-/bind-pattern-local", :kind "defn-", :line 90, :end-line 92, :hash "-357983377"} {:id "defn-/bind-pattern-locals", :kind "defn-", :line 94, :end-line 102, :hash "-954573492"} {:id "form/11/declare", :kind "declare", :line 104, :end-line 104, :hash "1302116001"} {:id "defn-/local-callable-effects", :kind "defn-", :line 106, :end-line 115, :hash "75363154"} {:id "defn-/if-callable-effects", :kind "defn-", :line 117, :end-line 122, :hash "765082213"} {:id "defn-/callable-effects", :kind "defn-", :line 124, :end-line 139, :hash "138662341"} {:id "defn-/binding-call-effects", :kind "defn-", :line 141, :end-line 143, :hash "1627316679"} {:id "defn-/effect-union", :kind "defn-", :line 145, :end-line 147, :hash "-2017324127"} {:id "defn-/call-effects", :kind "defn-", :line 149, :end-line 153, :hash "899417580"} {:id "defn-/lambda-effects", :kind "defn-", :line 155, :end-line 165, :hash "-660105978"} {:id "defn-/try-effects", :kind "defn-", :line 167, :end-line 183, :hash "1493624249"} {:id "defn-/binding-ctx", :kind "defn-", :line 185, :end-line 191, :hash "542892397"} {:id "defn-/let-effects", :kind "defn-", :line 193, :end-line 205, :hash "-1106430720"} {:id "defn-/seq-effects", :kind "defn-", :line 207, :end-line 219, :hash "-1853656406"} {:id "defn-/loop-effects", :kind "defn-", :line 221, :end-line 233, :hash "1753178605"} {:id "defn-/expr-effect-handlers", :kind "defn-", :line 235, :end-line 424, :hash "1042543100"} {:id "defn/expr-effects*", :kind "defn", :line 426, :end-line 429, :hash "1640622703"} {:id "defn/expr-effects", :kind "defn", :line 431, :end-line 434, :hash "-425404032"} {:id "defn-/check-contracts", :kind "defn-", :line 436, :end-line 442, :hash "-190924871"} {:id "defn-/invariant-ctx", :kind "defn-", :line 444, :end-line 452, :hash "-1341369256"} {:id "defn-/check-invariants", :kind "defn-", :line 454, :end-line 460, :hash "-1140560710"} {:id "defn-/check-fn-decl", :kind "defn-", :line 462, :end-line 471, :hash "254737222"} {:id "defn/check-module", :kind "defn", :line 473, :end-line 483, :hash "1481191546"}]}

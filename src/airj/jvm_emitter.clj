...
(def ^:private emit-expr-handlers
  {:jvm-local emit-local
   ...
   :jvm-seq-empty-new (fn [mv expr env]
                        (jvm-emit-text/emit-seq-empty-new mv expr env))
   ...
   :jvm-seq-append (fn [mv expr env]
                     (jvm-emit-text/emit-seq-append mv expr env {:emit-expr emit-expr}))
